...
@Component({
  selector: 'app-book-none',
  templateUrl: './book-none.component.html',
  styleUrls: ['./book-none.component.css']
})
export class BookNoneComponent implements OnInit {
  listBook: IBook[];
  constructor( private bookService:BookService, private router: Router) { }

  ngOnInit() {
        this.bookService.getBooks().subscribe(next => { this.listBook= next;
          this.listBook = this.listBook.filter(t => t.completed === false);
      });;
  }
