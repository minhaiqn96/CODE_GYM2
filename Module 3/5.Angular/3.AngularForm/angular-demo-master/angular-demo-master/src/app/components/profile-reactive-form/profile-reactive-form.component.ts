...
export class ProfileReactiveFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.profileForm = new FormGroup({
      ...
      username: new FormControl('',[Validators.required, Validators.minLength(6), this.forbiddenUsername123]),
   ...
   */
  forbiddenUsername123(control: AbstractControl): any {
  ...
  get username123(): AbstractControl {
    return this.profileForm.get('username');
  }

  get passwordGroup123(): AbstractControl {
